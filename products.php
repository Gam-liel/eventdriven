...
<div class="container-fluid">
	...
	<div class="span2">
          <div class="well sidebar-nav">
			...
			<li><a href="supplier.php"><i class="icon-user icon-2x"></i> Agents</a>                                    </li>
            <li class="active"><a href="products.php"><i class="icon-table icon-2x"></i> Customer Record</a>                                     </li>
	...
	<div class="contentheader">
			<i class="icon-table"></i> Customer Record
			</div>
			<ul class="breadcrumb">
...
<a rel="facebox" href="addproduct.php"><Button type="submit" class="btn btn-info" style="float:right; width:280px; height:35px;" /><i class="icon-plus-sign icon-large"></i> Add Customer Record</button></a><br><br>
</div>
 <form action="products.php" method="get">
      <div class="content" id="content">
      <div style="font-weight:bold; text-align:center;font-size:14px;margin-bottom: 15px;">
      <center><div style="font:bold 25px 'Aleo';">CUSTOMER RECORD</div>
	          WATER REFILLING MANAGEMENT SYSTEM	<br> <br>
	    </center>
</div>
<table class="table table-bordered" id="resultTable" border="2" cellpadding="11" cellspacing="0" style="font-family: arial; font-size: 12px; text-align:left;" width="100%">
	<thead>
		<tr>
	...
	<tbody>
			...
			<a rel="facebox" href="view_sale.php?iv=<?php echo $row['invoice_number']; ?>"> <button class="btn btn-primary btn-mini"><i class="icon-search"></i> View </button></a> 
            </tr>
			<?php
				}
			?>
