...
<div class="container-fluid">
	...
	<div class="span2">
          <div class="well sidebar-nav">
			...
			<li class="active"><a href="supplier.php"><i class="icon-user icon-2x"></i> Agent</a>                                    </li>
...
<?php 
			...
			Total Number of Agent: <font color="green" style="font:bold 22px 'Aleo';">[<?php echo $rowcount;?>]</font>
			</div>
</div>
<input type="text" name="filter" style="height:35px; margin-top: -1px;" value="" id="filter" placeholder="Search Agent..." autocomplete="off" />
<a rel="facebox" href="addsupplier.php"><Button type="submit" class="btn btn-info" style="float:right; width:230px; height:35px;" /><i class="icon-plus-sign icon-large"></i> Add Agent</button></a><br><br>
